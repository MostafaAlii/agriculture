									...
									jQuery(document).ready(function($){
										...
										var slider = $('#vegas-slider'),
											slides = [
												{
													name: "img 1",
													src: 'frontassets/img/home_img/img_1.jpg'
												},
												{
													name: "img 2",
													src: 'frontassets/img/home_img/img_2.jpg'
												},
												{
													name: "img 3",
													src: 'frontassets/img/home_img/img_3.jpg'
												}
											],
										...
										slider.vegas({
											...
											delay: 5000,
											slides: slides,
											overlay: 'frontassets/img/home_img/overlays/05.png',
