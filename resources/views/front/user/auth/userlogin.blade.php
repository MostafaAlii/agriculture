        ...
        <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                        ...
                        <form class="auth-form" name="form-login" method="POST" action="{{ route('User.login') }}" autocomplete="off">
                            ...
                            <div class="row align-items-center justify-content-between">
                                ...
                                <div class="col-auto">
                                    <a class="link-forgot" href="{{ route('password.request') }}"> {{ __('Website/home.lostpassword') }}</a>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
                        ...
                        <!-- start form -->
                        <form class="auth-form" action="{{ route('user.register.post') }}" method="post" autocomplete="off">
                            @csrf
