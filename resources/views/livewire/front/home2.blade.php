            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-4  text-center">
                    <div data-aos="fade-up" ddata-aos-duration="600" data-aos-offset="100">
                        <img class="img-fluid  lazy" src="{{ asset('frontassets/img/blank.gif') }}"
                            data-src="{{ asset('frontassets/img/img_1.png') }}" alt="demo" />
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div data-aos="fade-right" data-aos-delay="400" data-aos-duration="500" ddata-aos-offset="100">
                        ...
                        <p>
                            ...
                            text. It has roots in a piece of classi
                        </p>
                            ...
                            <div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="300">
                                <div class="d-table">
                                    ...
                                    <div class="d-table-cell align-middle">
                                        ...
                                        <p class="__title">{{ __('Admin/site.departments') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-3">
                            <div class="__item" data-aos="zoom-in" data-aos-duration="350" data-aos-delay="600">
                                <div class="d-table">
                                    ...
                                    <div class="d-table-cell align-middle">
                                        <p class="__count js-count" data-from="0" data-to="{{ \App\Models\Tag::count() }}">{{ \App\Models\Tag::count() }}</p>

                                        <p class="__title">{{ trans('Admin/site.tag') }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <p>
                                                    <a class="custom-btn custom-btn--medium custom-btn--style-1"
                                                        href="{{ route('shop') }}">{{ __('website\home.all_products') }}</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @foreach ($home_category as $cat)
                                ...
                                <div class="__item">
                                        ...
                                        <figure class="__image">
                                            @if (!$cat->products->isEmpty())
                                                @foreach ($cat->products->random(1) as $pp)
                                                    <img class="lazy"
                                                        src="{{ asset('Dashboard/img/products/' . $pp->image->filename) }}"
                                    ...
                                    <div class="__content">
                                        <h3 class="__title">
                                            @if ($x == 5)
                                                <center><b>{{ $category_count }}</b></center>
                                                {{ __('website\home.cat_count') }} @else{{ $cat->name }}
                                            @endif
                                        </h3>
                                    </div>

                                    @if ($x != 5)
                                        <a class="__link" href="{{ route('pro_cat', encrypt($cat->id)) }}"></a>
                                    @endif
                                </div>
                        </div>
                        <!-- end item -->
                    ...
                    <div class="review__item__text">
                        <p>
                            <i>Latin words, combined with a handful of model sentence structures, to generate Lorem
                                ...
                                literature from 45 BC, making it over</i>
                        </p>
                    </div>
