                    ...
                    <div class="col-12 col-md-8 col-lg-9">
                       ...
                       <center>
                        ...
                        @else
                             <div class="alert alert-danger">
                                <center>
قم بتسجيل الدخول للسيستم لكى تتمكن من اضافه تعليق                                   
                                </center>
                            </div>
                        @endif
                                ...
                                <tr>
                                    <td width="100%">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <form action="/comments/{{ $comment->id }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
                                                @csrf
                                                @method('delete')
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-12">
                                                    <div class="form-group">
                                                        <!-- Modal -->
                                                        <div class="modal animated flipInY text-left" id="delete{{ $comment->id }}" tabindex="-1" role="dialog" aria-hidden="true">
