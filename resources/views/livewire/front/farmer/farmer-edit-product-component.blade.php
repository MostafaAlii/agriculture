@section('title', __('website\home.farmereditproduct'))
@section('css')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- start checkout -->
                    <div class="checkout">
                        <h2>{{ __('Admin/products.editproduct') }}</h2>
                        <h1> <a href="{{ route('farmer.product') }}" class="btn btn-primary btn-lg"> <i class="fa fa-plus"></i> {{ __('Admin/site.back') }}</a></h1>
                        <div class="spacer py-3"></div>

                        <form class="checkout__form" method="post"  wire:submit.prevent="updateProduct" enctype="multipart/form-data" autocomplete="off">
