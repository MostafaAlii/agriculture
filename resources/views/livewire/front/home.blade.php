...
<div>
    ...
    as $blog)
                            <div class="col-12 col-md-6 col-lg-4">
                                ...
                                @else
                                    <a class="__item" href="#"><img
                                            src="{{ asset('frontassets/img/promo-banners_img/1.jpg') }}" alt="demo"
                ...
                <div class="__inner">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-lg">
                            <div class="__item">
                                <i class="__ico">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#ff9191"
                                        viewBox="0 0 512 512">
                                        <path
                        ...
                        <div class="review__item__author  d-table">
                            <div class="d-table-cell align-middle">
                                <div class="review__item__author-image">
                                    <img class="circled" src="{{ asset('frontassets/img/ava.png') }}"
                                        alt="ava" />
                                </div>
                            </div>
                                    ...
                                    <figure class="__image">
                                        ...
                                        @else
                                            <img src="{{ asset('frontassets/img/blank.gif') }}"
                                                data-src="{{ asset('frontassets/img/posts_img/1.jpg') }}"
                                                alt="demo" />
                                        @endif
                                    </figure>
                                    <div class="__content">
