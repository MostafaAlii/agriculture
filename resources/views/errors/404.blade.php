                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-lg-4 col-md-8 col-10 p-0">
                            <div class="card-header bg-transparent border-0">
                                <h1 class="error-code text-center mb-2">{{ trans('Admin\error.404_number') }}</h1>
                                <h2 class="text-uppercase text-center text-danger">{{ trans('Admin\error.404_content') }}</h2>
                            </div>
                            <div class="card-content">
                                <div class="row py-2">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 mb-1">
                                        <a href="{{ route('home.admin') }}" class="btn btn-danger btn-block">
                                            <i class="material-icons">public</i>
                                            {{ trans('Admin\error.visit_website') }}
                                        </a>
                                    </div>
                                </div>
                            </div>
