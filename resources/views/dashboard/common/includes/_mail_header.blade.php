<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/vendors/css/editors/quill/quill.snow.css')}}">
    ...
    @if (App::getLocale() == 'en')
       ...
       <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/vendors/css/vendors.min.css')}}">
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/custom-ltr.css') }}">
        <!-- END: Theme CSS-->
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css/pages/app-email.css')}}">
        <!-- END: Page CSS-->
    ...
    @else
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/css-rtl/pages/app-email.css')}}">
        <!-- END: Page CSS-->
