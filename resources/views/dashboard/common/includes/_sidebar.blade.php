    ...
    <div class="main-menu material-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="material-icons">tv</i><span class="menu-title" data-i18n="Templates">{{__('Admin\site.administaration_part')}}</span></a>
                    <ul class="menu-content">
                        <ul>
                            <li>
                                <a class="menu-item" href="{{route('AdminDepartments.index')}}"><i class="material-icons"></i><span data-i18n="Vertical">{{__('Admin\site.admin_departments')}}</span></a>

                            </li>
                            <li>
                                <a class="menu-item" href="{{route('AdminDepartments.create')}}"><i class="material-icons"></i><span data-i18n="Vertical">{{__('Admin\site.add_admin_departments')}}</span></a>
                        ...
                        <li><a class="menu-item" href="{{route('LandCategories.index')}}"><i class="material-icons"></i><span data-i18n="Vertical">{{__('Admin\site.land_category')}}</span></a>
