                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/income_products.income_productPageTitle') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    @can('income-products-create')
                                        <a href="{{ route('IncomeProducts.create') }}" class="btn btn-primary btn-sm mb-3"><i class="material-icons">add_box</i> {{ __('Admin/site.create') }}</a>
                                    @endcan
                                    @can('income-products-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="income-table">
                                            <thead>
                                                <tr>
                                                    <th>
...
<script>
    let adminsTable = $('#income-table').DataTable({
        ...
        ajax: {
            url: '{{ route('income_products.data') }}',
        },
        columns: [
