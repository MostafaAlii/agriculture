...
@endsection
@section('pageTitle')
    {{ trans('Admin/income_products.income_local_products_details_in_date_report') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/income_products.income_local_products_details_in_date_report') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">{{ __('Admin/income_products.income_local_products_database_details_in_date_report') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/income_products.income_local_products_details_in_date_report') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <!-- Start Filter -->
                                    @can('income-local-product-statistics-filter')
...
<script>
        ...
        $('#income_local_products_periodly-statistic-table').DataTable({
            processing: true,
            serverSide: true,
            dom: 'Bfrtip',
            ...
            ajax: {
                url: "{{ URL::to('dashboard_admin/dtable_weekly_monthly_anual_income_local_product') }}" ,
                type: 'GET',
                data: function (d) {
    ...
    $('#btnFiterSubmitSearch').click(function(){
        $('#income_local_products_periodly-statistic-table').DataTable().draw(true);
    });
