...
@endsection
@section('pageTitle')
    {{ trans('Admin/lands.landCategoryPageTitle') }}
@endsection
    ...
    <div class="content-wrapper">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('LandCategories.index') }}">{{ trans('Admin/lands.landCategoryPageTitle') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <section id="configuration">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('Admin/lands.landCategoryPageTitle') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <!-- Start Table -->
                                        <table class="table table-striped table-bordered zero-configuration" id="land_category_table">
                                            <thead>
                                            <tr>
                                                <th>
                                                    <input type="checkbox" name="select_all" id="select-all">
                                                </th>
                                                <th>{{ __('Admin/lands.category_name') }}</th>

                                                <th>{{ __('Admin/lands.category_type') }}</th>
                ...
                <!-- End row -->
                @include('dashboard.admin.land_categories.btn_.add')
            </section>
...
@section('js')
    ...
    <!-- Datatable Fire -->
    <script>
        let countriesTable = $('#land_category_table').DataTable({
            // dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
