                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('Options.index',encrypt($real_id)) }}">{{ trans('Admin/options.options') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <input type="hidden" id="attr_id" name="attr_id" value="{{$real_id}}">
                                        <!-- End Table -->
                                    </div>
...
<script>
    ...
    let countriesTable = $('#options-table').DataTable({
        ...
        ajax: {
           ...
           url: "{{ URL::to('dashboard_admin/options_data')}}/" + attribute_id,
        },
        columns: [
