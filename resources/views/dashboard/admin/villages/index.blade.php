    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <section id="configuration">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('Admin/villages.villagePageTitle') }}</h4>
                                ...
                                <div class="card-body card-dashboard">
                                    @can('village-create')
                                        <button type="button" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#add">
                                            ...
                                            {{ trans('Admin/villages.add_new_village') }}
                                    </button>
                                   @endcan
                                   @can('village-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <!-- Start Table -->
                                        <table class="table table-striped table-bordered zero-configuration" id="villages-table">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="checkbox" name="select_all" id="select-all">
                                                    </th>
                                                    <th>{{ __('Admin/villages.village_name') }}</th>
                                                    <th>{{ __('Admin/villages.state_name') }}</th>
                ...
                <!-- End row -->
                 @include('dashboard.admin.villages.btn.add')
            </section>
...
<!-- Datatable Fire -->
<script>
    let villagesTable = $('#villages-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
        "language": {
        ...
        columns: [
            ...
            {data: 'state', name: 'state.name', searchable: false, sortable: false},
