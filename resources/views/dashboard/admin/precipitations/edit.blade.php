...
@endsection
@section('pageTitle')
    {{ trans('Admin/orchards.precipitationsPageTitle') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{trans('Admin\precipitations.precipitations')}}</h3>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">{{ __('Admin/precipitations.editprecipitation') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{ route('Precipitations.update',encrypt($precipitation->id)) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="form-body">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div  class="form-group mb-3">
                                                        ...
                                                        <hr>
                                                        <div id="jstree"></div>
                                                        <input name="admin_department_id" type="hidden" value="{{$precipitation->admin_department_id}}" class="admin_department_id">
                                            ...
                                            <div class="form-actions center">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{ __('Admin/precipitations.update') }}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
@section('js')
    ...
    <script  type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#jstree').jstree({
                "core" : {
                    'data' :   {!! load_dep($precipitation->admin_department_id) !!},
                    "themes" : {
                        "variant" : "large"
                    }
                },
