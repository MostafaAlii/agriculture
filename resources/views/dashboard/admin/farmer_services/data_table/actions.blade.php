@can('farmer-service-edit')
    <a href="{{ route('FarmerServices.edit',  encrypt($id)) }}" class="btn btn-info btn-sm">
        <i class="fa fa-edit"></i>
        {{ __('Admin/services.edit') }}
    </a>
@endcan
@can('farmer-service-delete')
...
@endcan
                ...
                <div class="modal animated flipInY text-left"  tabindex="-1" role="dialog" aria-hidden="true" id="delete{{ $id }}">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <form action="{{ route('FarmerServices.destroy', encrypt($id)) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
                                    @csrf
                                    @method('delete')
      ...
      {{-- modal bulk delete --}}
      <form action="{{ route('farmer_service.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
