                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">{{ __('Admin/services.newfarmerService') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{ route('FarmerServices.store') }}" >
                                        @csrf
                                        @method('post')
                                        <div class="form-body">
                                            {{--farmer location--}}
                                            ...
                                            {{--farmer services--}}
                                                   <div class="row">
                                                       <div class="col">
                                                           <div  class="form-group">
                                                               <label for="id_h4_multi">{{ __('Admin/services.agriServices') }}</label>
                                                               <select name="agri_services[]"class="select2 form-control"multiple="multiple" id="id_h4_multi">
                                                       ...
                                                       <div class="col">
                                                           <div  class="form-group">
                                                               <label for="id_h6_multi">{{ __('Admin/services.waterServices') }}</label>
                                                               <select name="water_services[]"class="select2 form-control"multiple="multiple" id="id_h6_multi">
                                            ...
                                            <div class="form-actions center">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{ __('Admin/services.save') }}
                                                </button>
                                            </div>
