                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/services.farmerServicePageTitle') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    @can('farmer-service-create')
                                        <a href="{{ route('FarmerServices.create') }}" class="btn btn-primary btn-sm mb-3"><i class="material-icons">add_box</i> {{ __('Admin/site.create') }}</a>
                                    @endcan
                                    @can('farmer-service-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="farmerservice-table">
                                            <thead>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <th>{{ __('Admin/services.waterServices') }}</th>
