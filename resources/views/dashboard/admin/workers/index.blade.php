    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/site.workers') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">{{ __('Admin/site.home') }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="#">{{ __('Admin/site.workers') }}</a>
                            </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/site.workers') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    @can('worker-create')
                                    <a href="{{ route('workers.create') }}" class="btn btn-primary btn-sm mb-3"><i class="material-icons">add_box</i> {{ __('Admin/site.create') }}</a>
                                    @endcan
                                    @can('worker-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="workers-table">
                                            <thead>
                                                <tr>
                                                    <th>
...
<script>
    let workersTable = $('#workers-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
