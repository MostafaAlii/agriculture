                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">{{ __('Admin/site.slider') }}</a>
                            </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/site.slider') }}</h4>
...
<script>
    let usersTable = $('#sliders-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
        ...
        columns: [
            ...
            {data: 'subtitle', name: 'subtitle', searchable: false, sortable: false},
