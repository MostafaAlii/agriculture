@can('photo-slider-edit')
    <a href="{{ route('sliders.edit', encrypt($id)) }}" class="btn btn-info btn-sm">
        <i class="fa fa-edit"></i>
        {{ __('Admin/site.edit') }}
    </a>
@endcan
@can('photo-slider-delete')
...
<form action="{{ route('sliders.destroy', encrypt($id)) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    ...
    {{-- modal bulk delete --}}
<form action="{{ route('sliders.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
