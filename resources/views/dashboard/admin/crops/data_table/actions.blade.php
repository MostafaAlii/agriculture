...
<button type="button" class="btn btn-btn btn-info btn-sm " data-toggle="modal" data-target="#edit{{ $id }}">
    <i class="fa fas-edit">{{__('Admin\crops.edit')}}</i>
</button>
</div>
        ...
        <div class="modal animated flipInY text-left" tabindex="-1" role="dialog" aria-hidden="true"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('Crops.destroy', encrypt($id)) }}" class="my-1 my-xl-0"
        ...
        <div class="modal animated flipInY text-left" tabindex="-1" role="dialog" aria-hidden="true" id="edit{{ $id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('Crops.update', encrypt($id)) }}" class="my-1 my-xl-0" method="post"
                        ...
                        @php
                            $crop = \App\Models\Crop::findorfail($id)->first();
                        @endphp
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" class="select2 form-control">
                                    ...
                                    <optgroup label="{{ trans('Admin\crops.please_choose_crop_type') }}">
                                        <option value="{{$crop->crop_type}}" selected>
                                            {{$crop->crop_type}}
                                        </option>
                                        <option value="summer">
...
{{-- modal bulk delete --}}
<form action="{{ route('crops.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
