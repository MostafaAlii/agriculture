@can('brands-edit')
    <a href="{{ route('brands.edit', encrypt($id)) }}" class="btn btn-info btn-sm">
...
<form action="{{ route('brands.destroy', encrypt($id)) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    ...
    {{-- modal bulk delete --}}
    <form action="{{ route('brands.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
