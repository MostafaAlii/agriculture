                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">{{ __('Admin/site.brand') }}</a>
                            </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/site.brand') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    @can('brands-create')
                                        <a href="{{ route('brands.create') }}" class="btn btn-primary btn-sm mb-3">
                                            <i class="material-icons">add_box</i> {{ __('Admin/site.create') }}
                                        </a>
                                    @endcan
                                    @can('brands-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="brands-table" >
                                            <thead>
                                                <tr>
                                                    <th>
...
<script>
    let usersTable = $('#brands-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
