...
@endsection
@section('pageTitle')
    {{ trans('Admin/outcome_products.outcome_products_report') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/outcome_products.outcome_products_report') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">{{ __('Admin/outcome_products.database_about_outcome_products') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/outcome_products.database_about_outcome_products') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    <form class="form" method="POST" action="{{ route('outcome_product_statistics') }}">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="form-actions center">
                                                ...
                                                <a type="button" href="{{route('index_outcome_products')}}" class="btn btn-info">{{__('Admin\p_houses.back')}}</a>
                                    ...
                                    <br/>
                                    @if(isset($outcome_products))
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="outcome_product_statistic-table">
                                            <thead>
                                                <tr>
...
<script>
     ...
     let adminsTable = $('#outcome_product_statistic-table').DataTable({
         dom: 'Bfrtip',
         "language": {
