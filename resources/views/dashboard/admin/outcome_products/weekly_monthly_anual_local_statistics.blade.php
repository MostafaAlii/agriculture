                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    @can('index-outcome-local-products-statistics-filter')
                                        ...
                                        <form action="{{route('dtable_weekly_monthly_anual_outcome_local_product')}}" method="get">
...
<script>
    ...
    let adminsTable = $('#outcome_local_products_periodly-statistic-table').DataTable({
        dom: 'Bfrtip',
        "language": {
