                                    ...
                                    <form class="form" method="post" action="{{ route('blogs.update', encrypt($blog->id)) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="eventRegInput1" class="form-control"  name="title" value="{{ old('firstname',$blog->title) }}" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="admin_id" class="select2 form-control">
                                                    <optgroup label="{{ __('Admin/site.select') }}">
                                                        <option value="{{\App\Models\Admin::where('id',$blog->admin->id)->first()->id }}" selected>
                                                            {{\App\Models\Admin::where('id',$blog->admin->id)->first()->firstname }}
                                                            {{\App\Models\Admin::where('id',$blog->admin->id)->first()->lastname}}
                                                        </option>
