                                        ...
                                        <table class="table table-striped table-bordered zero-configuration" id="orchard-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ __('Admin/site.orchard_area') }}</th>
                                                    <th>{{ __('Admin/site.tree_count_per_orchard') }}</th>
...
<script>
    let adminsTable = $('#orchard-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
        ...
        columns: [
            ...
            {data: 'orchard_area', name: 'orchard_area'},
            {data: 'tree_count_per_orchard', name: 'tree_count_per_orchard'},
