                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="project_name" value="{{$animal->project_name}}"  class="form-control"type="text">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="animal_count" value="{{$animal->animal_count}}"  class="form-control"type="number">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="hall_num" value="{{$animal->hall_num}}"  class="form-control"type="number">
