...
@endsection
@section('pageTitle')
    {{ trans('Admin/animals.fish_govermental_supported_report') }}
@endsection
@section('content')
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('Animals.index') }}">{{ __('Admin/animals.fish_govermental_supported') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/animals.fish_govermental_supported_report') }}</h4>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="animals-table">
                                            ...
                                            <tbody>
                                            @foreach($fish_statistics as $statistic)
                                                <tr>
                                                    <td>#</td>
