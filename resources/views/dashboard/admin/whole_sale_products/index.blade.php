...
@endsection
@section('pageTitle')
    {{ trans('Admin\whole_sale_products.WholeSaleProductPageTitle') }}
@endsection
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <section id="configuration">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('Admin/whole_sale_products.WholeSaleProductPageTitle') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body card-dashboard">
                                    @can('whole-sale-products-create')
                                        <button type="button" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#add">
                                            <i class="material-icons">add_box</i>
                                            {{ trans('Admin/whole_sale_products.add_new_product') }}
                                        </button>
                                    @endcan
                                    @can('whole-sale-products-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <!-- Start Table -->
                                        <table class="table table-striped table-bordered zero-configuration" id="whole_sale_products_table">
                                            <thead>
                                            <tr>
                                                <th>
                                                    <input type="checkbox" name="select_all" id="select-all">
                                                </th>
                                                <th>{{ __('Admin/whole_sale_products.name') }}</th>


                                                <th>{{ __('Admin/general.created_since') }}</th>
                                                <th>{{ __('Admin/lands.action') }}</th>
                                            </tr>
                                            </thead>
                                        </table>
                                        <!-- End Table -->
                ...
                <!-- End row -->
                @include('dashboard.admin.whole_sale_products.btn_.add')
            </section>
...
@section('js')
    ...
    <!-- Datatable Fire -->
    <script>
        let countriesTable = $('#whole_sale_products_table').DataTable({
            serverSide: true,
            processing: true,
            ...
            ajax: {
                url: '{{ route('whole_sale_products.data') }}',
            },
            columns: [
