                        ...
                        <div class="card-body">
                            <form class="form-horizontal"  novalidate method="POST" action="{{ route('admin.login.post') }}" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 col-12 float-sm-left text-center text-sm-right"><a href="recover-password.html" class="card-link">{{ trans('Admin/login.forget_password') }}</a></div>
                                </div>
                                <button type="submit" class="btn btn-outline-info btn-block"><i class="ft-unlock"></i> {{ trans('Admin/login.login') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
