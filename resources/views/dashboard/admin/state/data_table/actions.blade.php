    ...
    <a href="{{ route('states.edit', encrypt($id)) }}" class="btn btn-success btn-sm">
    ...
    <form action="{{ route('states.destroy', $id) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
