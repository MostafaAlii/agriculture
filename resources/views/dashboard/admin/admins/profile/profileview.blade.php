                ...
                <div class="row">
                    <div class="col-12 col-sm-7">
                        <div class="media mb-2">
                            <img class="users-avatar-shadow rounded-circle img-preview" height="64" width="64"" src="{{ $admin->image_path ? $admin->image_path : URL::asset('Dashboard/img/Default/default_admin.jpg') }}"
