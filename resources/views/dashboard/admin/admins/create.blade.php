                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control " name="address"  type="text" id="pac-input">
                                                        <input class="form-control " value="" name="latitude"  type="hidden" id="latitude">
                                                        <input class="form-control " value="" name="longitude"  type="hidden" id="longitude">
                                                    </div>
                                                </div>
...
@section('js')
    ...
    {{--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDKZAuxH9xTzD2DLY2nKSPKrgRi2_y0ejs&libraries=places&callback=initAutocomplete&language=ar&region=EG--}}
         {{--async defer"></script>--}}
    {{--<script src="https://maps.googleapis.com/maps/api/js?libraries=places&callback=initAutocomplete&language=ar&region=EG--}}
    {{--async defer"></script>--}}
