...
<a href="{{ route('Payments.edit',encrypt($id)) }}" class="btn btn-primary btn-sm">
    {{ __('Admin/site.edit') }}
</a>
...
<form action="{{ route('Payments.destroy',encrypt($id)) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
  ...
  {{-- modal bulk delete --}}
  <form action="{{-- route('attributes.bulk_delete','ids') --}}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
