    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <section id="configuration">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('Admin/states.statePageTitle') }}</h4>
                                ...
                                <div class="card-body card-dashboard">
                                    @can('state-create')
                                        <button type="button" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#add">
                                            ...
                                            {{ trans('Admin/states.add_new_state') }}
                                    </button>
                                   @endcan
                                   @can('state-delete-all')
                                    ...
                                    <div class="table-responsive">
                                        <!-- Start Table -->
                                        <table class="table table-striped table-bordered zero-configuration" id="states-table">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <input type="checkbox" name="select_all" id="select-all">
                                                    </th>
                                                    <th>{{ __('Admin/states.state_name') }}</th>
                                                    <th>{{ __('Admin/states.area_name') }}</th>
                                                    <th>{{ __('Admin/states.village_name') }}</th>
                ...
                <!-- End row -->
                 @include('dashboard.admin.states.btn.add')
            </section>
...
<!-- Datatable Fire -->
<script>
    let statesTable = $('#states-table').DataTable({
        // dom: "tiplr",
        serverSide: true,
        processing: true,
        "language": {
