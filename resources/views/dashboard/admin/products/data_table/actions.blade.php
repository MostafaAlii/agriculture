    <a href="{{ route('product_edit', encrypt($products->id)) }}" class="btn btn-success btn-sm">
        <i class="fa fa-edit"></i>
        {{ __('Admin/site.edit') }}
    </a> 
    <button type="button" class="btn btn-btn btn-danger btn-sm " data-toggle="modal" data-target="#delete{{ $products->id }}">
        <i class="fa fa-trash"></i>
        {{ __('Admin/site.delete') }}
    </button>


    <form action="{{ route('product_delete', encrypt($products->id)) }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
        @csrf
        @method('delete')
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="form-group">
                <!-- Modal -->
                <div class="modal animated flipInY text-left" id="delete{{ $products->id }}" tabindex="-1" role="dialog" aria-hidden="true">
