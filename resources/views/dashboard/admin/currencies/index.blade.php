...
@endsection
@section('pageTitle')
    {{ trans('Admin\currencies.Currencies') }}
@endsection
    ...
    <div class="content-wrapper">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('Currencies.index') }}">{{ trans('Admin/currencies.Currencies') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-body">
            ...
            <section id="configuration">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">{{ trans('Admin\currencies.Currencies') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                ...
                                <div class="card-body card-dashboard">
                                    <button type="button" class="btn btn-primary btn-sm mb-3" data-toggle="modal" data-target="#add">
                                        ...
                                        {{ trans('Admin\currencies.add_new_currency') }}
                                    </button>
                                    ...
                                    <div class="table-responsive">
                                        <!-- Start Table -->
                                        <table class="table table-striped table-bordered zero-configuration" id="currency_table">
                                            <thead>
                                            <tr>
                                                <th>
                ...
                <!-- End row -->
                @include('dashboard.admin.currencies.btn.add')
            </section>
...
@section('js')
    ...
    <!-- Datatable Fire -->
    <script>
        let countriesTable = $('#currency_table').DataTable({
            // dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
