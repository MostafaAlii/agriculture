    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{trans('Admin\land_areas.v')}}</h3>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">{{ __('Admin/site.editlandArea') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{ route('LandAreas.update',encrypt($land_area->id)) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')
                                        <div class="form-body">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div  class="form-group mb-3">
                                                        ...
                                                        <hr>
                                                        <div id="jstree"></div>
                                                        <input name="admin_department_id" type="hidden" value="{{$land_area->admin_department_id}}" class="admin_department_id">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="L_area" value="{{$land_area->L_area}}"  class="form-control"type="text">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select form-control" id="customSelect" name="unit_id" >
                                                            <option value="{{$land_area->unit_id}}">{{$land_area->unit->Name}}</option>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label>{{ __('Admin/land_areas.land_category') }}</label>
                                                        <select class="custom-select form-control" id="customSelect" name="land_category_id" >
                                                            <option value="{{$land_area->land_category_id}}">{{$land_area->landCategory->category_name}}</option>
                                            ...
                                            <div class="form-actions center">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{ __('Admin/land_areas.update') }}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
...
@section('js')
    ...
    <script  type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#jstree').jstree({
                "core" : {
                    'data' :   {!! load_dep($land_area->admin_department_id) !!},
                    "themes" : {
                        "variant" : "large"
                    }
                },
