...
@endsection
@section('pageTitle')
    {{ trans('Admin/land_areas.land_areas_state_report') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/land_areas.land_areas_state_report') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">{{ __('Admin/land_areas.database_about_land_areas_state') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/land_areas.database_about_land_areas_state') }}</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered zero-configuration" id="land-area-statistic-state-table">
                                            <thead>
                                                <tr>
                                                    <th>
