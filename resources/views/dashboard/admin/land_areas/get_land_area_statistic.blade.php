...
@endsection
@section('pageTitle')
    {{ trans('Admin/land_areas.land_areas_report') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/land_areas.land_areas_report') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="">{{ __('Admin/land_areas.database_about_land_areas') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Admin/land_areas.database_about_land_areas') }}</h4>
