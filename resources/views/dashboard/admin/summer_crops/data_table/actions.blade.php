        ...
        <div class="modal animated flipInY text-left" tabindex="-1" role="dialog" aria-hidden="true"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('SummerCrops.destroy', encrypt($id)) }}" class="my-1 my-xl-0"
        ...
        <div class="modal animated flipInY text-left" tabindex="-1" role="dialog" aria-hidden="true" id="edit{{ $id }}">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('SummerCrops.update', encrypt($id)) }}" class="my-1 my-xl-0" method="post"
                        ...
                        @php
                            $crop = \App\Models\SummerCrop::findorfail($id)->first();
                        @endphp
...
{{-- modal bulk delete --}}
<form action="{{ route('summer_crops.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
