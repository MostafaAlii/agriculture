...
@endsection
@section('pageTitle')
    {{ trans('Admin/p_houses.Database_about_greenhouses_private_supported') }}
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title">{{ __('Admin/p_houses.Database_about_greenhouses_private_supported') }}</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">{{ __('Admin/p_houses.report_on_the_number_of_greenhouses_private_supported') }}</a>
                                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title center" style="color: green">{{ __('Admin/p_houses.report_on_the_number_of_greenhouses_private_supported') }}</h3>
