...
{{--@endsection--}}
{{--@section('pageTitle')--}}
    {{--{{ trans('Admin/setting.adminDepartmentPageTitle') }}--}}
{{--@endsection--}}
{{--@section('content')--}}
                ...
                {{--<div class="row breadcrumbs-top">--}}
                    {{--<div class="breadcrumb-wrapper col-12">--}}
                        {{--<ol class="breadcrumb">--}}
                            ...
                            {{--</li>--}}
                            {{--<li class="breadcrumb-item"><a--}}
                                        {{--href="{{ route('settings') }}">{{trans('Admin\admin_departments.admin_departments')}}</a>--}}
                            {{--</li>--}}
                            ...
                            {{--<div class="card-content collapse show">--}}
                                {{--<div class="card-body">--}}
                                    {{--<div class="card-text">--}}
                                        {{--<p></p>--}}
                                    {{--</div>--}}
                                    {{--<form class="form" action="{{url('AdminDepartments.update',$admin_department->id)}}" method="post"--}}
                                        ...
                                        {{--<div class="form-body">--}}
                                            ...
                                            {{--<div class="row">--}}
                                                {{--<div class="col-md-6">--}}
                                                    {{--<div class="form-group">--}}
                                                        ...
                                                        {{--<input type="text" id="projectinput1" class="form-control"--}}
                                                               {{--placeholder="{{trans('Admin\admin_departments.name')}}"--}}
                                                               {{--name="name"  value="{{$admin_department->name}}">--}}
                                                ...
                                                {{--<div class="col-md-6">--}}
                                                    {{--<div class="form-group">--}}
                                                        {{--<label>{{trans('Admin\admin_departments.icon')}} </label>--}}
                                                        {{--<label id="projectinput7" class="file center-block"></label>--}}
                                                        {{--<label id="projectinput7" class="file center-block">--}}

                                                            {{--<input type="file"  name="image"  onchange="loadFile(event)">--}}
                                                            {{--<img--}}
                                                                    {{--src="{{asset('Dashboard/img/AdminDepartment/'.$admin_department->icon)}}"--}}
                                            ...
                                            {{--<div class="row">--}}
                                                {{--<div class="col col-md-12">--}}
                                                    {{--<div class="form-group">--}}
                                                        ...
                                                        {{--<div id="jstree"></div>--}}
                                                        {{--<input name="parent" type="hidden" value="{{$admin_department->parent}}" class="parent_id">--}}
                                                    {{--</div>--}}
                                                {{--</div>--}}
                                            {{--</div>--}}
                                            ...
                                            {{--<div class="row">--}}
                                                {{--<div class="col col-md-6">--}}
                                                    {{--<div class="form-group">--}}
                                                        ...
                                                        {{--<textarea type="text" id="companyName" class="form-control" value="{{$admin_department->keys}}"--}}
    ...
    {{--<script  type="text/javascript">--}}
        ...
        {{--$(document).ready(function () {--}}
            ...
            {{--$('#jstree').jstree({--}}
                {{--"core" : {--}}
                    {{--'data' :--}}
                    {{--{!! load_dep($admin_department->parent,$admin_department->id) !!}--}}
                    {{--,--}}
                    {{--"themes" : {--}}
                        {{--"variant" : "large"--}}
                    {{--}--}}
                                    ...
                                    <form class="form" action="{{route('AdminDepartments.update',$admin_department->id)}}" method="post"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="projectinput1" class="form-control" value="{{$admin_department->name}}"
                                                               placeholder="{{trans('Admin\admin_department.name')}}"  name="name" >
                                                        {{--<input type="hidden" id="projectinput1" class="form-control"  name="id" >--}}
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>{{trans('Admin\admin_department.icon')}} </label>
                                                        <label id="projectinput7" class="file center-block"></label>
                                                        <label id="projectinput7" class="file center-block">

                                                            <input type="file"  name="image"  onchange="loadFile(event)">
                                                            <img
                                                                    src="{{asset('Dashboard/img/AdminDepartment/'.$admin_department->image)}}"
                                                                    class="img-thumbnail img-preview" width="50px"
                                                                    height="50px" alt="icon" id="output">
