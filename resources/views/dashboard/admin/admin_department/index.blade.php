                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"
                                id="basic-layout-form">{{trans('Admin\admin_departments.index')}}</h4>
                                        ...
                                        <div class="modal-content">
                                         ...
                                         {{__('Admin\admin_departments.ask_delete')}} <span id="dept_name"></span>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary">{{__('Admin\admin_departments.save')}}</button>
                                                </div>
                                            </form>
...
<script  type="text/javascript">
   ...
   // listen for event
       .on('changed.jstree', function (e, data) {
           ...
           {{--$('#form_delete_department').attr('action','{{url(App::getLocale().'/dashboard_admin/adminDepartments')}}/'+r.join(', ')+'/delete')--}}
