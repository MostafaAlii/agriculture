                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" method="post" action="{{ route('farmers.store') }}">
                                        @csrf
                                        @method('post')
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             {{--password--}}
                                            <div class="form-group">
                                                <label>{{ __('farmers.password') }}<span class="text-danger">*</span></label>
                                                <input type="password" name="password" class="form-control" value="{{ old('password') }}" required>
                                            </div>

                                            {{--password_confirmation--}}
                                            <div class="form-group">
                                                <label>{{ ('farmers.password_confirmation') }}<span class="text-danger">*</span></label>
